...
Late returns of more than 60 minutes incur an additional half-day charge. Please call us if you anticipate being late.`,
  ...
  const settings = [
    ...
    { key: "contact_phone", value: "+383 44 123 456", group: "contact", label: "Phone Number", type: "text" },
    ...
    { key: "whatsapp_number", value: "+38344123456", group: "contact", label: "WhatsApp Number", type: "text" },
  ...
  const sampleBookings = [
    {
      ...
      subtotal: allCars[0].pricePerDay * 7,
      extrasTotal: 35,
      pickupFee: 15,
      dropoffFee: 0,
      discount: 0,
      depositAmount: allCars[0].deposit,
      totalAmount: allCars[0].pricePerDay * 7 + 35 + 15,
      pricingTier: "daily",
    ...
    },
    {
      ...
      subtotal: allCars[4].pricePerDay * 7,
      extrasTotal: 0,
      pickupFee: 0,
      dropoffFee: 0,
      discount: 0,
      depositAmount: allCars[4].deposit,
      totalAmount: allCars[4].pricePerDay * 7,
      pricingTier: "daily",
    ...
    },
    {
      ...
      subtotal: allCars[3].pricePerDay * 13,
      extrasTotal: 156,
      pickupFee: 15,
      dropoffFee: 15,
      discount: 0,
      depositAmount: allCars[3].deposit,
      totalAmount: allCars[3].pricePerDay * 13 + 156 + 30,
      pricingTier: "daily",
      status: BookingStatus.CONFIRMED,
      paymentStatus: PaymentStatus.PAID,
    ...
    },
    {
      ...
      subtotal: allCars[5].pricePerDay * 7,
      extrasTotal: 84,
      pickupFee: 15,
      dropoffFee: 15,
      discount: 0,
      depositAmount: allCars[5].deposit,
      totalAmount: allCars[5].pricePerDay * 7 + 84 + 30,
      pricingTier: "daily",
